...
import NoiDung from "./TeacherDetailContent";
function App() {
  ...
  return (
    <div>
      ...
      <div class="container-fluid pt-5 overlay">
            <img class="img-background" width="1555px" height="350px" style={{marginTop:'80px'}}
                src={background}
                alt="Đỗ Trung Thành" loading="lazy" />
            <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-6 ">

                    <div class="u-teacher-avatar">
                        <img class="rounded-circle" width="160px" height="160px"
                            src={avatar}
                            alt="Đỗ Trung Thành" loading="lazy" />
                    </div>
                    <div class="u-teacher-info">
                        <h1 class="text-black fw-bold"> Đỗ Trung Thành </h1>
                        <span class="text-black fw-bold"> Giảng viên Trường Cao đẳng Sư phạm Yên Bái, Thạc sỹ Khoa học
                            Máy tính </span>
                        <div class="uti-link">

                            <a href="https://www.facebook.com/thanh.dotrung" class="btn btn-light" role="button"
                                aria-disabled="true">Flow mình</a>
                            <a href="https://www.facebook.com/thanh.dotrung" class="btn btn-light" role="button"
                                aria-disabled="true">Nhắn cho mình</a>
