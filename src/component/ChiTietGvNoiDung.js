    ...
    <div className="center_body ">
      ...
      <div class="bg-light bg-gradient" id="infogiangvien">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="pre">
                                Đỗ Trung Thành- Giảng viên Trường Cao đẳng Sư phạm Yên Bái, Thạc sỹ Khoa học Máy tính
                            ...
                            <div>
                                <a class="see-more-info-btn" href="javascript:void(0)">Xem thêm</a>
                            </div>
      ...
      <div className="bg-light bg-gradient" id="noidung">
        <div class="p-2">
          ...
          <div className="d-inline-block card-course-text">
            <p>              
              <a className="link-offset-2 link-underline link-underline-opacity-0 text-black fw-bold" href="https://unica.vn/thiet-ke-trinh-chieu-powerpoint-2016-tu-a-z">
            ...
            <ul class="mini-des">
              ...
              <li>
              <FontAwesomeIcon icon={faClock}></FontAwesomeIcon> 05 giờ 30 phút
              </li>
            </ul>
            <ul>
              <li>
